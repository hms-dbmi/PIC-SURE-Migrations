...
add_migration="$repo_root/Baseline/auth/V7__ADD_BANNER_MANAGEMENT_ACCESS_RULE.sql"
expand_migration="$repo_root/Baseline/auth/V8__EXPAND_BANNER_MANAGEMENT_ACCESS_RULE.sql"
reorder_migration="$repo_root/Baseline/auth/V9__AUTHORIZE_BANNER_REORDER.sql"
disable_migration="$repo_root/Baseline/auth/V10__ALLOW_BANNER_DISABLE_ROUTE.sql"
archive_migration="$repo_root/Baseline/auth/V11__ALLOW_BANNER_ARCHIVE_ROUTE.sql"
restore_migration="$repo_root/Baseline/auth/V12__ALLOW_BANNER_RESTORE_ROUTE.sql"
